<template>
  <div class="min-h-screen">
    ...
    <section class="max-w-6xl mx-auto mb-12 px-4">
      <div class="bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg p-8 md:p-12 text-white-100">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          <div>
            <h3 class="text-xl font-semibold mb-4 text-blue-300">Business Analysis</h3>
            <div class="space-y-3">
              ...
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-blue-400 rounded-full"></div>
                <span>Process Modeling (BPMN)</span>
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-blue-400 rounded-full"></div>
          ...
          <div>
            <h3 class="text-xl font-semibold mb-4 text-green-300">Technical Tools</h3>
            <div class="space-y-3">
              <div class="flex items-center space-x-3">
    ...
    <!-- Education Snapshot -->
    <section class="max-w-6xl mx-auto mb-12 px-4">
      <div class="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-8 border-2 border-purple-200">
