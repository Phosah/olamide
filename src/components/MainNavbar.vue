<template>
    <nav class="flex items-center justify-between mb-3">
      <ul class="flex space-x-2 md:space-x-6 text-black-300 text-sm md:text-base cursor-pointer">
        <RouterLink
        ...
        <div class="relative group">
          ...
          <div
            class="absolute left-0 mt-2 w-56 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10"
          >
            <RouterLink
